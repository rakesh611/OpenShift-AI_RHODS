...
KFP models a workflow as a directed acyclic graph of components. Inputs, outputs, parameters, artifacts, conditions, loops, retries, caching, and execution metadata form the operating contract.
In this chapter, **Kubeflow Pipelines basics** is treated as a production platform capability rather than a dashboard feature.
The practical project goal is: Build and compile a first KFP v2 pipeline, import it into OpenShift AI, run it, and inspect the graph, parameters, logs, and artifacts.
### 1.1 Outcome
- Explain Kubeflow Pipelines basics in architectural, operational, security, and troubleshooting terms.
...
```
### 3.2 Control plane
- **KFP SDK:** determine ownership, lifecycle, availability, permissions, and evidence paths for this resource.
- **IR YAML:** determine ownership, lifecycle, availability, permissions, and evidence paths for this resource.
- **pipeline server API:** determine ownership, lifecycle, availability, permissions, and evidence paths for this resource.
- **component executor:** determine ownership, lifecycle, availability, permissions, and evidence paths for this resource.
- **ML Metadata:** determine ownership, lifecycle, availability, permissions, and evidence paths for this resource.
- **artifact repository:** determine ownership, lifecycle, availability, permissions, and evidence paths for this resource.
### 3.3 Data plane
...
### 4.1 Project name: `02-kubeflow-pipelines-basics-lab`
**Goal:** Build and compile a first KFP v2 pipeline, import it into OpenShift AI, run it, and inspect the graph, parameters, logs, and artifacts.
...
137. Open **Projects** and select the data science project.
138. Open the **Pipelines** area and select **Configure pipeline server**.
139. Provide S3 access key, secret key, endpoint, region, and bucket.
140. For production, select an external MySQL or MariaDB database rather than the development in-cluster database.
141. Keep pipeline-definition storage in Kubernetes when GitOps management is required.
142. Decide whether caching can be configured at pipeline and task level.
143. Submit the configuration and wait for DSPA readiness.
...
### 5.1 What makes **Kubeflow Pipelines basics** production grade
- Control **SDK/backend mismatch** through design-time validation, policy, observability, and a tested recovery procedure.
- Control **implicit dependencies** through design-time validation, policy, observability, and a tested recovery procedure.
- Control **incorrect type contracts** through design-time validation, policy, observability, and a tested recovery procedure.
- Control **mutable images** through design-time validation, policy, observability, and a tested recovery procedure.
- Control **missing artifact paths** through design-time validation, policy, observability, and a tested recovery procedure.
...
**Context for Kubeflow Pipelines basics:** Evaluate architecture boundary as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate business objective as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.3. Data Contract
**Context for Kubeflow Pipelines basics:** Evaluate data contract as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate input validation as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate output validation as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.6. Idempotency
**Context for Kubeflow Pipelines basics:** Evaluate idempotency as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.7. Retry Safety
**Context for Kubeflow Pipelines basics:** Evaluate retry safety as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate timeout strategy as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate resource requests as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate resource limits as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.11. Cpu Sizing
**Context for Kubeflow Pipelines basics:** Evaluate CPU sizing as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.12. Memory Sizing
**Context for Kubeflow Pipelines basics:** Evaluate memory sizing as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.13. Gpu Scheduling
**Context for Kubeflow Pipelines basics:** Evaluate GPU scheduling as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.14. Node Placement
**Context for Kubeflow Pipelines basics:** Evaluate node placement as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate taints and tolerations as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.16. Topology
**Context for Kubeflow Pipelines basics:** Evaluate topology as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate service account as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.18. Rbac
**Context for Kubeflow Pipelines basics:** Evaluate RBAC as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate secret handling as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.20. Token Lifetime
**Context for Kubeflow Pipelines basics:** Evaluate token lifetime as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.21. Network Policy
**Context for Kubeflow Pipelines basics:** Evaluate network policy as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.22. Egress Control
**Context for Kubeflow Pipelines basics:** Evaluate egress control as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.23. Dns Dependency
**Context for Kubeflow Pipelines basics:** Evaluate DNS dependency as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.24. Proxy Behavior
**Context for Kubeflow Pipelines basics:** Evaluate proxy behavior as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.25. Tls Trust
**Context for Kubeflow Pipelines basics:** Evaluate TLS trust as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate certificate rotation as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate image provenance as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate image digest pinning as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.29. Sbom
**Context for Kubeflow Pipelines basics:** Evaluate SBOM as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate vulnerability scanning as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate signature verification as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.32. S3 Endpoint
**Context for Kubeflow Pipelines basics:** Evaluate S3 endpoint as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.33. Bucket Policy
**Context for Kubeflow Pipelines basics:** Evaluate bucket policy as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate object prefix design as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate artifact lineage as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate artifact retention as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate metadata database as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate database backup as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate database connection pool as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.40. Workspace Pvc
**Context for Kubeflow Pipelines basics:** Evaluate workspace PVC as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.41. Storage Class
**Context for Kubeflow Pipelines basics:** Evaluate storage class as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.42. Access Mode
**Context for Kubeflow Pipelines basics:** Evaluate access mode as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate capacity planning as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.44. Latency Budget
**Context for Kubeflow Pipelines basics:** Evaluate latency budget as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.45. Throughput
**Context for Kubeflow Pipelines basics:** Evaluate throughput as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate small-object performance as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.47. Caching
**Context for Kubeflow Pipelines basics:** Evaluate caching as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate cache invalidation as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate parameter design as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.50. Default Values
**Context for Kubeflow Pipelines basics:** Evaluate default values as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate schema evolution as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate version compatibility as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.53. Logging
**Context for Kubeflow Pipelines basics:** Evaluate logging as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.54. Metrics
**Context for Kubeflow Pipelines basics:** Evaluate metrics as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.55. Events
**Context for Kubeflow Pipelines basics:** Evaluate events as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.56. Audit Trail
**Context for Kubeflow Pipelines basics:** Evaluate audit trail as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.57. Correlation Id
**Context for Kubeflow Pipelines basics:** Evaluate correlation ID as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.58. Alerting
**Context for Kubeflow Pipelines basics:** Evaluate alerting as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.59. Slo
**Context for Kubeflow Pipelines basics:** Evaluate SLO as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.60. Error Budget
**Context for Kubeflow Pipelines basics:** Evaluate error budget as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.61. Runbook
**Context for Kubeflow Pipelines basics:** Evaluate runbook as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate incident ownership as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.63. Change Control
**Context for Kubeflow Pipelines basics:** Evaluate change control as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate release promotion as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.65. Rollback
**Context for Kubeflow Pipelines basics:** Evaluate rollback as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate disaster recovery as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.67. Multi-Tenancy
**Context for Kubeflow Pipelines basics:** Evaluate multi-tenancy as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.68. Quota
**Context for Kubeflow Pipelines basics:** Evaluate quota as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate cost allocation as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.70. Cleanup
**Context for Kubeflow Pipelines basics:** Evaluate cleanup as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.71. Legal Hold
**Context for Kubeflow Pipelines basics:** Evaluate legal hold as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.72. Testing
**Context for Kubeflow Pipelines basics:** Evaluate testing as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.73. Unit Test
**Context for Kubeflow Pipelines basics:** Evaluate unit test as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate integration test as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
**Context for Kubeflow Pipelines basics:** Evaluate failure injection as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.76. Load Test
**Context for Kubeflow Pipelines basics:** Evaluate load test as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.77. Gitops
**Context for Kubeflow Pipelines basics:** Evaluate GitOps as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.78. Ci Validation
**Context for Kubeflow Pipelines basics:** Evaluate CI validation as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.79. Policy As Code
**Context for Kubeflow Pipelines basics:** Evaluate policy as code as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.80. Documentation
**Context for Kubeflow Pipelines basics:** Evaluate documentation as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 6.81. Support Model
**Context for Kubeflow Pipelines basics:** Evaluate support model as part of the end-to-end operating contract. Keywords: kubeflow, pipelines, basics.
...
### 14.1. How would you explain Kubeflow Pipelines basics to a platform architect?
**Expected L3 answer:** Address architecture, security, data, reliability, evidence, ownership, rollback, and version-specific validation for **Kubeflow Pipelines basics**.
...
- **Command 001:** `oc describe pod <pod> -n <project>`
...
- **Command 002:** `oc logs <pod> -n <project> --all-containers=true`
- Purpose: collect evidence related to output validation.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 003:** `oc logs <pod> -n <project> --all-containers=true --previous`
- Purpose: collect evidence related to idempotency.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 004:** `oc get pvc -n <project>`
- Purpose: collect evidence related to retry safety.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 005:** `oc describe pvc <pvc> -n <project>`
- Purpose: collect evidence related to timeout strategy.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 006:** `oc get sa,role,rolebinding -n <project>`
- Purpose: collect evidence related to resource requests.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 007:** `oc auth can-i --as=system:serviceaccount:<project>:<sa> create pods -n <project>`
- Purpose: collect evidence related to resource limits.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 008:** `oc get secret -n <project>`
- Purpose: collect evidence related to CPU sizing.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 009:** `oc get route,svc,endpoints -n <project>`
- Purpose: collect evidence related to memory sizing.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 010:** `oc get resourcequota,limitrange -n <project> -o yaml`
- Purpose: collect evidence related to GPU scheduling.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 011:** `oc get nodes -o wide`
- Purpose: collect evidence related to node placement.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 012:** `oc describe node <node>`
- Purpose: collect evidence related to taints and tolerations.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 013:** `oc get networkpolicy -n <project> -o yaml`
- Purpose: collect evidence related to topology.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 014:** `oc get dspa -n <project> -o yaml`
- Purpose: collect evidence related to service account.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 015:** `oc get pods -n <project> -o wide`
- Purpose: collect evidence related to RBAC.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 016:** `oc get events -n <project> --sort-by=.lastTimestamp`
- Purpose: collect evidence related to secret handling.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 017:** `oc describe pod <pod> -n <project>`
- Purpose: collect evidence related to token lifetime.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 018:** `oc logs <pod> -n <project> --all-containers=true`
- Purpose: collect evidence related to network policy.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 019:** `oc logs <pod> -n <project> --all-containers=true --previous`
- Purpose: collect evidence related to egress control.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 020:** `oc get pvc -n <project>`
- Purpose: collect evidence related to DNS dependency.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 021:** `oc describe pvc <pvc> -n <project>`
- Purpose: collect evidence related to proxy behavior.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 022:** `oc get sa,role,rolebinding -n <project>`
- Purpose: collect evidence related to TLS trust.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 023:** `oc auth can-i --as=system:serviceaccount:<project>:<sa> create pods -n <project>`
- Purpose: collect evidence related to certificate rotation.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 024:** `oc get secret -n <project>`
- Purpose: collect evidence related to image provenance.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 025:** `oc get route,svc,endpoints -n <project>`
- Purpose: collect evidence related to image digest pinning.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 026:** `oc get resourcequota,limitrange -n <project> -o yaml`
- Purpose: collect evidence related to SBOM.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 027:** `oc get nodes -o wide`
- Purpose: collect evidence related to vulnerability scanning.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 028:** `oc describe node <node>`
- Purpose: collect evidence related to signature verification.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 029:** `oc get networkpolicy -n <project> -o yaml`
- Purpose: collect evidence related to S3 endpoint.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 030:** `oc get dspa -n <project> -o yaml`
- Purpose: collect evidence related to bucket policy.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 031:** `oc get pods -n <project> -o wide`
- Purpose: collect evidence related to object prefix design.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 032:** `oc get events -n <project> --sort-by=.lastTimestamp`
- Purpose: collect evidence related to artifact lineage.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 033:** `oc describe pod <pod> -n <project>`
- Purpose: collect evidence related to artifact retention.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 034:** `oc logs <pod> -n <project> --all-containers=true`
- Purpose: collect evidence related to metadata database.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 035:** `oc logs <pod> -n <project> --all-containers=true --previous`
- Purpose: collect evidence related to database backup.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 036:** `oc get pvc -n <project>`
- Purpose: collect evidence related to database connection pool.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 037:** `oc describe pvc <pvc> -n <project>`
- Purpose: collect evidence related to workspace PVC.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 038:** `oc get sa,role,rolebinding -n <project>`
- Purpose: collect evidence related to storage class.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 039:** `oc auth can-i --as=system:serviceaccount:<project>:<sa> create pods -n <project>`
- Purpose: collect evidence related to access mode.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 040:** `oc get secret -n <project>`
- Purpose: collect evidence related to capacity planning.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 041:** `oc get route,svc,endpoints -n <project>`
- Purpose: collect evidence related to latency budget.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 042:** `oc get resourcequota,limitrange -n <project> -o yaml`
- Purpose: collect evidence related to throughput.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 043:** `oc get nodes -o wide`
- Purpose: collect evidence related to small-object performance.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 044:** `oc describe node <node>`
- Purpose: collect evidence related to caching.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 045:** `oc get networkpolicy -n <project> -o yaml`
- Purpose: collect evidence related to cache invalidation.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 046:** `oc get dspa -n <project> -o yaml`
- Purpose: collect evidence related to parameter design.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 047:** `oc get pods -n <project> -o wide`
- Purpose: collect evidence related to default values.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 048:** `oc get events -n <project> --sort-by=.lastTimestamp`
- Purpose: collect evidence related to schema evolution.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 049:** `oc describe pod <pod> -n <project>`
- Purpose: collect evidence related to version compatibility.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 050:** `oc logs <pod> -n <project> --all-containers=true`
- Purpose: collect evidence related to logging.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 051:** `oc logs <pod> -n <project> --all-containers=true --previous`
- Purpose: collect evidence related to metrics.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 052:** `oc get pvc -n <project>`
- Purpose: collect evidence related to events.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 053:** `oc describe pvc <pvc> -n <project>`
- Purpose: collect evidence related to audit trail.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 054:** `oc get sa,role,rolebinding -n <project>`
- Purpose: collect evidence related to correlation ID.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 055:** `oc auth can-i --as=system:serviceaccount:<project>:<sa> create pods -n <project>`
- Purpose: collect evidence related to alerting.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 056:** `oc get secret -n <project>`
- Purpose: collect evidence related to SLO.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 057:** `oc get route,svc,endpoints -n <project>`
- Purpose: collect evidence related to error budget.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 058:** `oc get resourcequota,limitrange -n <project> -o yaml`
- Purpose: collect evidence related to runbook.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 059:** `oc get nodes -o wide`
- Purpose: collect evidence related to incident ownership.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 060:** `oc describe node <node>`
- Purpose: collect evidence related to change control.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 061:** `oc get networkpolicy -n <project> -o yaml`
- Purpose: collect evidence related to release promotion.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 062:** `oc get dspa -n <project> -o yaml`
- Purpose: collect evidence related to rollback.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 063:** `oc get pods -n <project> -o wide`
- Purpose: collect evidence related to disaster recovery.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 064:** `oc get events -n <project> --sort-by=.lastTimestamp`
- Purpose: collect evidence related to multi-tenancy.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 065:** `oc describe pod <pod> -n <project>`
- Purpose: collect evidence related to quota.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 066:** `oc logs <pod> -n <project> --all-containers=true`
- Purpose: collect evidence related to cost allocation.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 067:** `oc logs <pod> -n <project> --all-containers=true --previous`
- Purpose: collect evidence related to cleanup.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 068:** `oc get pvc -n <project>`
- Purpose: collect evidence related to legal hold.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 069:** `oc describe pvc <pvc> -n <project>`
- Purpose: collect evidence related to testing.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 070:** `oc get sa,role,rolebinding -n <project>`
- Purpose: collect evidence related to unit test.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 071:** `oc auth can-i --as=system:serviceaccount:<project>:<sa> create pods -n <project>`
- Purpose: collect evidence related to integration test.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 072:** `oc get secret -n <project>`
- Purpose: collect evidence related to failure injection.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 073:** `oc get route,svc,endpoints -n <project>`
- Purpose: collect evidence related to load test.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 074:** `oc get resourcequota,limitrange -n <project> -o yaml`
- Purpose: collect evidence related to GitOps.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 075:** `oc get nodes -o wide`
- Purpose: collect evidence related to CI validation.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 076:** `oc describe node <node>`
- Purpose: collect evidence related to policy as code.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 077:** `oc get networkpolicy -n <project> -o yaml`
- Purpose: collect evidence related to documentation.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 078:** `oc get dspa -n <project> -o yaml`
- Purpose: collect evidence related to support model.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 079:** `oc get pods -n <project> -o wide`
- Purpose: collect evidence related to architecture boundary.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 080:** `oc get events -n <project> --sort-by=.lastTimestamp`
- Purpose: collect evidence related to business objective.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 081:** `oc describe pod <pod> -n <project>`
- Purpose: collect evidence related to data contract.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 082:** `oc logs <pod> -n <project> --all-containers=true`
- Purpose: collect evidence related to input validation.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 083:** `oc logs <pod> -n <project> --all-containers=true --previous`
- Purpose: collect evidence related to output validation.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 084:** `oc get pvc -n <project>`
- Purpose: collect evidence related to idempotency.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 085:** `oc describe pvc <pvc> -n <project>`
- Purpose: collect evidence related to retry safety.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 086:** `oc get sa,role,rolebinding -n <project>`
- Purpose: collect evidence related to timeout strategy.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 087:** `oc auth can-i --as=system:serviceaccount:<project>:<sa> create pods -n <project>`
- Purpose: collect evidence related to resource requests.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 088:** `oc get secret -n <project>`
- Purpose: collect evidence related to resource limits.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 089:** `oc get route,svc,endpoints -n <project>`
- Purpose: collect evidence related to CPU sizing.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 090:** `oc get resourcequota,limitrange -n <project> -o yaml`
- Purpose: collect evidence related to memory sizing.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 091:** `oc get nodes -o wide`
- Purpose: collect evidence related to GPU scheduling.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 092:** `oc describe node <node>`
- Purpose: collect evidence related to node placement.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 093:** `oc get networkpolicy -n <project> -o yaml`
- Purpose: collect evidence related to taints and tolerations.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 094:** `oc get dspa -n <project> -o yaml`
- Purpose: collect evidence related to topology.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 095:** `oc get pods -n <project> -o wide`
- Purpose: collect evidence related to service account.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 096:** `oc get events -n <project> --sort-by=.lastTimestamp`
- Purpose: collect evidence related to RBAC.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 097:** `oc describe pod <pod> -n <project>`
- Purpose: collect evidence related to secret handling.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 098:** `oc logs <pod> -n <project> --all-containers=true`
- Purpose: collect evidence related to token lifetime.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 099:** `oc logs <pod> -n <project> --all-containers=true --previous`
- Purpose: collect evidence related to network policy.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 100:** `oc get pvc -n <project>`
- Purpose: collect evidence related to egress control.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 101:** `oc describe pvc <pvc> -n <project>`
- Purpose: collect evidence related to DNS dependency.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 102:** `oc get sa,role,rolebinding -n <project>`
- Purpose: collect evidence related to proxy behavior.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 103:** `oc auth can-i --as=system:serviceaccount:<project>:<sa> create pods -n <project>`
- Purpose: collect evidence related to TLS trust.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 104:** `oc get secret -n <project>`
- Purpose: collect evidence related to certificate rotation.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 105:** `oc get route,svc,endpoints -n <project>`
- Purpose: collect evidence related to image provenance.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 106:** `oc get resourcequota,limitrange -n <project> -o yaml`
- Purpose: collect evidence related to image digest pinning.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 107:** `oc get nodes -o wide`
- Purpose: collect evidence related to SBOM.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 108:** `oc describe node <node>`
- Purpose: collect evidence related to vulnerability scanning.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 109:** `oc get networkpolicy -n <project> -o yaml`
- Purpose: collect evidence related to signature verification.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 110:** `oc get dspa -n <project> -o yaml`
- Purpose: collect evidence related to S3 endpoint.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 111:** `oc get pods -n <project> -o wide`
- Purpose: collect evidence related to bucket policy.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 112:** `oc get events -n <project> --sort-by=.lastTimestamp`
- Purpose: collect evidence related to object prefix design.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 113:** `oc describe pod <pod> -n <project>`
- Purpose: collect evidence related to artifact lineage.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 114:** `oc logs <pod> -n <project> --all-containers=true`
- Purpose: collect evidence related to artifact retention.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 115:** `oc logs <pod> -n <project> --all-containers=true --previous`
- Purpose: collect evidence related to metadata database.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 116:** `oc get pvc -n <project>`
- Purpose: collect evidence related to database backup.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 117:** `oc describe pvc <pvc> -n <project>`
- Purpose: collect evidence related to database connection pool.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 118:** `oc get sa,role,rolebinding -n <project>`
- Purpose: collect evidence related to workspace PVC.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 119:** `oc auth can-i --as=system:serviceaccount:<project>:<sa> create pods -n <project>`
- Purpose: collect evidence related to storage class.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
- **Command 120:** `oc get secret -n <project>`
- Purpose: collect evidence related to access mode.
- Safety: read the command, namespace, and output destination before execution.
- Record: timestamp, user, cluster, namespace, run, pipeline version, and change ticket.
## 16. Corporate operating standard
- **Standard 001:** For Kubeflow Pipelines basics, the topology control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 002:** For Kubeflow Pipelines basics, the service account control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 003:** For Kubeflow Pipelines basics, the RBAC control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 004:** For Kubeflow Pipelines basics, the secret handling control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 005:** For Kubeflow Pipelines basics, the token lifetime control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 006:** For Kubeflow Pipelines basics, the network policy control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 007:** For Kubeflow Pipelines basics, the egress control control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 008:** For Kubeflow Pipelines basics, the DNS dependency control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 009:** For Kubeflow Pipelines basics, the proxy behavior control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 010:** For Kubeflow Pipelines basics, the TLS trust control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 011:** For Kubeflow Pipelines basics, the certificate rotation control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 012:** For Kubeflow Pipelines basics, the image provenance control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 013:** For Kubeflow Pipelines basics, the image digest pinning control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 014:** For Kubeflow Pipelines basics, the SBOM control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 015:** For Kubeflow Pipelines basics, the vulnerability scanning control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 016:** For Kubeflow Pipelines basics, the signature verification control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 017:** For Kubeflow Pipelines basics, the S3 endpoint control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 018:** For Kubeflow Pipelines basics, the bucket policy control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 019:** For Kubeflow Pipelines basics, the object prefix design control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 020:** For Kubeflow Pipelines basics, the artifact lineage control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 021:** For Kubeflow Pipelines basics, the artifact retention control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 022:** For Kubeflow Pipelines basics, the metadata database control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 023:** For Kubeflow Pipelines basics, the database backup control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 024:** For Kubeflow Pipelines basics, the database connection pool control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 025:** For Kubeflow Pipelines basics, the workspace PVC control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 026:** For Kubeflow Pipelines basics, the storage class control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 027:** For Kubeflow Pipelines basics, the access mode control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 028:** For Kubeflow Pipelines basics, the capacity planning control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 029:** For Kubeflow Pipelines basics, the latency budget control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 030:** For Kubeflow Pipelines basics, the throughput control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 031:** For Kubeflow Pipelines basics, the small-object performance control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 032:** For Kubeflow Pipelines basics, the caching control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 033:** For Kubeflow Pipelines basics, the cache invalidation control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 034:** For Kubeflow Pipelines basics, the parameter design control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 035:** For Kubeflow Pipelines basics, the default values control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 036:** For Kubeflow Pipelines basics, the schema evolution control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 037:** For Kubeflow Pipelines basics, the version compatibility control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 038:** For Kubeflow Pipelines basics, the logging control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 039:** For Kubeflow Pipelines basics, the metrics control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 040:** For Kubeflow Pipelines basics, the events control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 041:** For Kubeflow Pipelines basics, the audit trail control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 042:** For Kubeflow Pipelines basics, the correlation ID control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 043:** For Kubeflow Pipelines basics, the alerting control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 044:** For Kubeflow Pipelines basics, the SLO control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 045:** For Kubeflow Pipelines basics, the error budget control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 046:** For Kubeflow Pipelines basics, the runbook control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 047:** For Kubeflow Pipelines basics, the incident ownership control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 048:** For Kubeflow Pipelines basics, the change control control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 049:** For Kubeflow Pipelines basics, the release promotion control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 050:** For Kubeflow Pipelines basics, the rollback control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 051:** For Kubeflow Pipelines basics, the disaster recovery control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 052:** For Kubeflow Pipelines basics, the multi-tenancy control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 053:** For Kubeflow Pipelines basics, the quota control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 054:** For Kubeflow Pipelines basics, the cost allocation control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 055:** For Kubeflow Pipelines basics, the cleanup control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 056:** For Kubeflow Pipelines basics, the legal hold control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 057:** For Kubeflow Pipelines basics, the testing control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 058:** For Kubeflow Pipelines basics, the unit test control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 059:** For Kubeflow Pipelines basics, the integration test control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 060:** For Kubeflow Pipelines basics, the failure injection control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 061:** For Kubeflow Pipelines basics, the load test control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 062:** For Kubeflow Pipelines basics, the GitOps control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 063:** For Kubeflow Pipelines basics, the CI validation control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 064:** For Kubeflow Pipelines basics, the policy as code control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 065:** For Kubeflow Pipelines basics, the documentation control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 066:** For Kubeflow Pipelines basics, the support model control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 067:** For Kubeflow Pipelines basics, the architecture boundary control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 068:** For Kubeflow Pipelines basics, the business objective control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 069:** For Kubeflow Pipelines basics, the data contract control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 070:** For Kubeflow Pipelines basics, the input validation control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 071:** For Kubeflow Pipelines basics, the output validation control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 072:** For Kubeflow Pipelines basics, the idempotency control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 073:** For Kubeflow Pipelines basics, the retry safety control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 074:** For Kubeflow Pipelines basics, the timeout strategy control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 075:** For Kubeflow Pipelines basics, the resource requests control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 076:** For Kubeflow Pipelines basics, the resource limits control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 077:** For Kubeflow Pipelines basics, the CPU sizing control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 078:** For Kubeflow Pipelines basics, the memory sizing control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 079:** For Kubeflow Pipelines basics, the GPU scheduling control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 080:** For Kubeflow Pipelines basics, the node placement control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 081:** For Kubeflow Pipelines basics, the taints and tolerations control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 082:** For Kubeflow Pipelines basics, the topology control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 083:** For Kubeflow Pipelines basics, the service account control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 084:** For Kubeflow Pipelines basics, the RBAC control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 085:** For Kubeflow Pipelines basics, the secret handling control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 086:** For Kubeflow Pipelines basics, the token lifetime control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 087:** For Kubeflow Pipelines basics, the network policy control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 088:** For Kubeflow Pipelines basics, the egress control control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 089:** For Kubeflow Pipelines basics, the DNS dependency control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 090:** For Kubeflow Pipelines basics, the proxy behavior control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 091:** For Kubeflow Pipelines basics, the TLS trust control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 092:** For Kubeflow Pipelines basics, the certificate rotation control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 093:** For Kubeflow Pipelines basics, the image provenance control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 094:** For Kubeflow Pipelines basics, the image digest pinning control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 095:** For Kubeflow Pipelines basics, the SBOM control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 096:** For Kubeflow Pipelines basics, the vulnerability scanning control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 097:** For Kubeflow Pipelines basics, the signature verification control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 098:** For Kubeflow Pipelines basics, the S3 endpoint control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 099:** For Kubeflow Pipelines basics, the bucket policy control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 100:** For Kubeflow Pipelines basics, the object prefix design control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 101:** For Kubeflow Pipelines basics, the artifact lineage control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 102:** For Kubeflow Pipelines basics, the artifact retention control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 103:** For Kubeflow Pipelines basics, the metadata database control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 104:** For Kubeflow Pipelines basics, the database backup control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 105:** For Kubeflow Pipelines basics, the database connection pool control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 106:** For Kubeflow Pipelines basics, the workspace PVC control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 107:** For Kubeflow Pipelines basics, the storage class control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 108:** For Kubeflow Pipelines basics, the access mode control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 109:** For Kubeflow Pipelines basics, the capacity planning control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 110:** For Kubeflow Pipelines basics, the latency budget control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 111:** For Kubeflow Pipelines basics, the throughput control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 112:** For Kubeflow Pipelines basics, the small-object performance control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 113:** For Kubeflow Pipelines basics, the caching control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 114:** For Kubeflow Pipelines basics, the cache invalidation control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 115:** For Kubeflow Pipelines basics, the parameter design control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 116:** For Kubeflow Pipelines basics, the default values control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 117:** For Kubeflow Pipelines basics, the schema evolution control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 118:** For Kubeflow Pipelines basics, the version compatibility control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 119:** For Kubeflow Pipelines basics, the logging control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 120:** For Kubeflow Pipelines basics, the metrics control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 121:** For Kubeflow Pipelines basics, the events control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 122:** For Kubeflow Pipelines basics, the audit trail control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 123:** For Kubeflow Pipelines basics, the correlation ID control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 124:** For Kubeflow Pipelines basics, the alerting control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 125:** For Kubeflow Pipelines basics, the SLO control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 126:** For Kubeflow Pipelines basics, the error budget control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 127:** For Kubeflow Pipelines basics, the runbook control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 128:** For Kubeflow Pipelines basics, the incident ownership control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 129:** For Kubeflow Pipelines basics, the change control control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 130:** For Kubeflow Pipelines basics, the release promotion control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 131:** For Kubeflow Pipelines basics, the rollback control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 132:** For Kubeflow Pipelines basics, the disaster recovery control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 133:** For Kubeflow Pipelines basics, the multi-tenancy control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 134:** For Kubeflow Pipelines basics, the quota control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 135:** For Kubeflow Pipelines basics, the cost allocation control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 136:** For Kubeflow Pipelines basics, the cleanup control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 137:** For Kubeflow Pipelines basics, the legal hold control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 138:** For Kubeflow Pipelines basics, the testing control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 139:** For Kubeflow Pipelines basics, the unit test control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 140:** For Kubeflow Pipelines basics, the integration test control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 141:** For Kubeflow Pipelines basics, the failure injection control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 142:** For Kubeflow Pipelines basics, the load test control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 143:** For Kubeflow Pipelines basics, the GitOps control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 144:** For Kubeflow Pipelines basics, the CI validation control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 145:** For Kubeflow Pipelines basics, the policy as code control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 146:** For Kubeflow Pipelines basics, the documentation control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 147:** For Kubeflow Pipelines basics, the support model control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 148:** For Kubeflow Pipelines basics, the architecture boundary control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 149:** For Kubeflow Pipelines basics, the business objective control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 150:** For Kubeflow Pipelines basics, the data contract control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 151:** For Kubeflow Pipelines basics, the input validation control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 152:** For Kubeflow Pipelines basics, the output validation control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 153:** For Kubeflow Pipelines basics, the idempotency control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 154:** For Kubeflow Pipelines basics, the retry safety control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 155:** For Kubeflow Pipelines basics, the timeout strategy control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 156:** For Kubeflow Pipelines basics, the resource requests control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 157:** For Kubeflow Pipelines basics, the resource limits control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 158:** For Kubeflow Pipelines basics, the CPU sizing control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 159:** For Kubeflow Pipelines basics, the memory sizing control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 160:** For Kubeflow Pipelines basics, the GPU scheduling control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 161:** For Kubeflow Pipelines basics, the node placement control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 162:** For Kubeflow Pipelines basics, the taints and tolerations control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 163:** For Kubeflow Pipelines basics, the topology control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 164:** For Kubeflow Pipelines basics, the service account control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 165:** For Kubeflow Pipelines basics, the RBAC control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 166:** For Kubeflow Pipelines basics, the secret handling control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 167:** For Kubeflow Pipelines basics, the token lifetime control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 168:** For Kubeflow Pipelines basics, the network policy control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 169:** For Kubeflow Pipelines basics, the egress control control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 170:** For Kubeflow Pipelines basics, the DNS dependency control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 171:** For Kubeflow Pipelines basics, the proxy behavior control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 172:** For Kubeflow Pipelines basics, the TLS trust control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 173:** For Kubeflow Pipelines basics, the certificate rotation control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 174:** For Kubeflow Pipelines basics, the image provenance control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 175:** For Kubeflow Pipelines basics, the image digest pinning control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 176:** For Kubeflow Pipelines basics, the SBOM control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 177:** For Kubeflow Pipelines basics, the vulnerability scanning control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 178:** For Kubeflow Pipelines basics, the signature verification control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 179:** For Kubeflow Pipelines basics, the S3 endpoint control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 180:** For Kubeflow Pipelines basics, the bucket policy control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 181:** For Kubeflow Pipelines basics, the object prefix design control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 182:** For Kubeflow Pipelines basics, the artifact lineage control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 183:** For Kubeflow Pipelines basics, the artifact retention control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 184:** For Kubeflow Pipelines basics, the metadata database control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 185:** For Kubeflow Pipelines basics, the database backup control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 186:** For Kubeflow Pipelines basics, the database connection pool control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 187:** For Kubeflow Pipelines basics, the workspace PVC control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 188:** For Kubeflow Pipelines basics, the storage class control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 189:** For Kubeflow Pipelines basics, the access mode control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 190:** For Kubeflow Pipelines basics, the capacity planning control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 191:** For Kubeflow Pipelines basics, the latency budget control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 192:** For Kubeflow Pipelines basics, the throughput control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 193:** For Kubeflow Pipelines basics, the small-object performance control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 194:** For Kubeflow Pipelines basics, the caching control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 195:** For Kubeflow Pipelines basics, the cache invalidation control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
- **Standard 196:** For Kubeflow Pipelines basics, the parameter design control must explicitly reduce the risk of implicit dependencies; evidence must be reviewable by another engineer.
- **Standard 197:** For Kubeflow Pipelines basics, the default values control must explicitly reduce the risk of incorrect type contracts; evidence must be reviewable by another engineer.
- **Standard 198:** For Kubeflow Pipelines basics, the schema evolution control must explicitly reduce the risk of mutable images; evidence must be reviewable by another engineer.
- **Standard 199:** For Kubeflow Pipelines basics, the version compatibility control must explicitly reduce the risk of missing artifact paths; evidence must be reviewable by another engineer.
- **Standard 200:** For Kubeflow Pipelines basics, the logging control must explicitly reduce the risk of SDK/backend mismatch; evidence must be reviewable by another engineer.
...
### 20.1. Production verification record — timeout strategy
- **Topic:** Kubeflow Pipelines basics
...
### 20.2. Production verification record — resource requests
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** missing artifact paths
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.3. Production verification record — resource limits
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** SDK/backend mismatch
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.4. Production verification record — CPU sizing
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** implicit dependencies
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.5. Production verification record — memory sizing
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** incorrect type contracts
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.6. Production verification record — GPU scheduling
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** mutable images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.7. Production verification record — node placement
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** missing artifact paths
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.8. Production verification record — taints and tolerations
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** SDK/backend mismatch
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.9. Production verification record — topology
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** implicit dependencies
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.10. Production verification record — service account
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** incorrect type contracts
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.11. Production verification record — RBAC
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** mutable images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.12. Production verification record — secret handling
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** missing artifact paths
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.13. Production verification record — token lifetime
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** SDK/backend mismatch
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.14. Production verification record — network policy
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** implicit dependencies
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.15. Production verification record — egress control
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** incorrect type contracts
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.16. Production verification record — DNS dependency
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** mutable images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.17. Production verification record — proxy behavior
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** missing artifact paths
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.18. Production verification record — TLS trust
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** SDK/backend mismatch
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.19. Production verification record — certificate rotation
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** implicit dependencies
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.20. Production verification record — image provenance
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** incorrect type contracts
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.21. Production verification record — image digest pinning
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** mutable images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.22. Production verification record — SBOM
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** missing artifact paths
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.23. Production verification record — vulnerability scanning
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** SDK/backend mismatch
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.24. Production verification record — signature verification
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** implicit dependencies
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.25. Production verification record — S3 endpoint
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** incorrect type contracts
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.26. Production verification record — bucket policy
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** mutable images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.27. Production verification record — object prefix design
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** missing artifact paths
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.28. Production verification record — artifact lineage
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** SDK/backend mismatch
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.29. Production verification record — artifact retention
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** implicit dependencies
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.30. Production verification record — metadata database
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** incorrect type contracts
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.31. Production verification record — database backup
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** mutable images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.32. Production verification record — database connection pool
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** missing artifact paths
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.33. Production verification record — workspace PVC
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** SDK/backend mismatch
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.34. Production verification record — storage class
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** implicit dependencies
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.35. Production verification record — access mode
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** incorrect type contracts
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.36. Production verification record — capacity planning
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** mutable images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.37. Production verification record — latency budget
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** missing artifact paths
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.38. Production verification record — throughput
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** SDK/backend mismatch
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.39. Production verification record — small-object performance
- **Topic:** Kubeflow Pipelines basics
- **Risk addressed:** implicit dependencies
