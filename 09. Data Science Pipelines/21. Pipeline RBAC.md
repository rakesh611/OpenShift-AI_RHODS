...
In this chapter, **Pipeline RBAC** is treated as a production platform capability rather than a dashboard feature.
The practical project goal is: Implement project roles and fine-grained RBAC for pipeline administration, authoring, execution, observation, and support.
### 1.1 Outcome
- Explain Pipeline RBAC in architectural, operational, security, and troubleshooting terms.
...
### 4.1 Project name: `21-pipeline-rbac-lab`
**Goal:** Implement project roles and fine-grained RBAC for pipeline administration, authoring, execution, observation, and support.
...
### 5.1 What makes **Pipeline RBAC** production grade
...
**Context for Pipeline RBAC:** Evaluate architecture boundary as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate business objective as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.3. Data Contract
**Context for Pipeline RBAC:** Evaluate data contract as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate input validation as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate output validation as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.6. Idempotency
**Context for Pipeline RBAC:** Evaluate idempotency as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.7. Retry Safety
**Context for Pipeline RBAC:** Evaluate retry safety as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate timeout strategy as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate resource requests as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate resource limits as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.11. Cpu Sizing
**Context for Pipeline RBAC:** Evaluate CPU sizing as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.12. Memory Sizing
**Context for Pipeline RBAC:** Evaluate memory sizing as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.13. Gpu Scheduling
**Context for Pipeline RBAC:** Evaluate GPU scheduling as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.14. Node Placement
**Context for Pipeline RBAC:** Evaluate node placement as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate taints and tolerations as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.16. Topology
**Context for Pipeline RBAC:** Evaluate topology as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate service account as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.18. Rbac
**Context for Pipeline RBAC:** Evaluate RBAC as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate secret handling as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.20. Token Lifetime
**Context for Pipeline RBAC:** Evaluate token lifetime as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.21. Network Policy
**Context for Pipeline RBAC:** Evaluate network policy as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.22. Egress Control
**Context for Pipeline RBAC:** Evaluate egress control as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.23. Dns Dependency
**Context for Pipeline RBAC:** Evaluate DNS dependency as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.24. Proxy Behavior
**Context for Pipeline RBAC:** Evaluate proxy behavior as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.25. Tls Trust
**Context for Pipeline RBAC:** Evaluate TLS trust as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate certificate rotation as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate image provenance as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate image digest pinning as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.29. Sbom
**Context for Pipeline RBAC:** Evaluate SBOM as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate vulnerability scanning as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate signature verification as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.32. S3 Endpoint
**Context for Pipeline RBAC:** Evaluate S3 endpoint as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.33. Bucket Policy
**Context for Pipeline RBAC:** Evaluate bucket policy as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate object prefix design as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate artifact lineage as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate artifact retention as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate metadata database as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate database backup as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate database connection pool as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.40. Workspace Pvc
**Context for Pipeline RBAC:** Evaluate workspace PVC as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.41. Storage Class
**Context for Pipeline RBAC:** Evaluate storage class as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.42. Access Mode
**Context for Pipeline RBAC:** Evaluate access mode as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate capacity planning as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.44. Latency Budget
**Context for Pipeline RBAC:** Evaluate latency budget as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.45. Throughput
**Context for Pipeline RBAC:** Evaluate throughput as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate small-object performance as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.47. Caching
**Context for Pipeline RBAC:** Evaluate caching as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate cache invalidation as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate parameter design as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.50. Default Values
**Context for Pipeline RBAC:** Evaluate default values as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate schema evolution as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate version compatibility as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.53. Logging
**Context for Pipeline RBAC:** Evaluate logging as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.54. Metrics
**Context for Pipeline RBAC:** Evaluate metrics as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.55. Events
**Context for Pipeline RBAC:** Evaluate events as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.56. Audit Trail
**Context for Pipeline RBAC:** Evaluate audit trail as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.57. Correlation Id
**Context for Pipeline RBAC:** Evaluate correlation ID as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.58. Alerting
**Context for Pipeline RBAC:** Evaluate alerting as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.59. Slo
**Context for Pipeline RBAC:** Evaluate SLO as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.60. Error Budget
**Context for Pipeline RBAC:** Evaluate error budget as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.61. Runbook
**Context for Pipeline RBAC:** Evaluate runbook as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate incident ownership as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.63. Change Control
**Context for Pipeline RBAC:** Evaluate change control as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate release promotion as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.65. Rollback
**Context for Pipeline RBAC:** Evaluate rollback as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate disaster recovery as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.67. Multi-Tenancy
**Context for Pipeline RBAC:** Evaluate multi-tenancy as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.68. Quota
**Context for Pipeline RBAC:** Evaluate quota as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate cost allocation as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.70. Cleanup
**Context for Pipeline RBAC:** Evaluate cleanup as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.71. Legal Hold
**Context for Pipeline RBAC:** Evaluate legal hold as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.72. Testing
**Context for Pipeline RBAC:** Evaluate testing as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.73. Unit Test
**Context for Pipeline RBAC:** Evaluate unit test as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate integration test as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
**Context for Pipeline RBAC:** Evaluate failure injection as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.76. Load Test
**Context for Pipeline RBAC:** Evaluate load test as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.77. Gitops
**Context for Pipeline RBAC:** Evaluate GitOps as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.78. Ci Validation
**Context for Pipeline RBAC:** Evaluate CI validation as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.79. Policy As Code
**Context for Pipeline RBAC:** Evaluate policy as code as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.80. Documentation
**Context for Pipeline RBAC:** Evaluate documentation as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 6.81. Support Model
**Context for Pipeline RBAC:** Evaluate support model as part of the end-to-end operating contract. Keywords: pipeline, rbac.
...
### 14.1. How would you explain Pipeline RBAC to a platform architect?
**Expected L3 answer:** Address architecture, security, data, reliability, evidence, ownership, rollback, and version-specific validation for **Pipeline RBAC**.
...
- **Standard 001:** For Pipeline RBAC, the quota control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 002:** For Pipeline RBAC, the cost allocation control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 003:** For Pipeline RBAC, the cleanup control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 004:** For Pipeline RBAC, the legal hold control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 005:** For Pipeline RBAC, the testing control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 006:** For Pipeline RBAC, the unit test control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 007:** For Pipeline RBAC, the integration test control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 008:** For Pipeline RBAC, the failure injection control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 009:** For Pipeline RBAC, the load test control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 010:** For Pipeline RBAC, the GitOps control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 011:** For Pipeline RBAC, the CI validation control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 012:** For Pipeline RBAC, the policy as code control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 013:** For Pipeline RBAC, the documentation control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 014:** For Pipeline RBAC, the support model control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 015:** For Pipeline RBAC, the architecture boundary control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 016:** For Pipeline RBAC, the business objective control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 017:** For Pipeline RBAC, the data contract control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 018:** For Pipeline RBAC, the input validation control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 019:** For Pipeline RBAC, the output validation control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 020:** For Pipeline RBAC, the idempotency control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 021:** For Pipeline RBAC, the retry safety control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 022:** For Pipeline RBAC, the timeout strategy control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 023:** For Pipeline RBAC, the resource requests control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 024:** For Pipeline RBAC, the resource limits control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 025:** For Pipeline RBAC, the CPU sizing control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 026:** For Pipeline RBAC, the memory sizing control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 027:** For Pipeline RBAC, the GPU scheduling control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 028:** For Pipeline RBAC, the node placement control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 029:** For Pipeline RBAC, the taints and tolerations control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 030:** For Pipeline RBAC, the topology control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 031:** For Pipeline RBAC, the service account control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 032:** For Pipeline RBAC, the RBAC control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 033:** For Pipeline RBAC, the secret handling control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 034:** For Pipeline RBAC, the token lifetime control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 035:** For Pipeline RBAC, the network policy control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 036:** For Pipeline RBAC, the egress control control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 037:** For Pipeline RBAC, the DNS dependency control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 038:** For Pipeline RBAC, the proxy behavior control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 039:** For Pipeline RBAC, the TLS trust control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 040:** For Pipeline RBAC, the certificate rotation control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 041:** For Pipeline RBAC, the image provenance control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 042:** For Pipeline RBAC, the image digest pinning control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 043:** For Pipeline RBAC, the SBOM control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 044:** For Pipeline RBAC, the vulnerability scanning control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 045:** For Pipeline RBAC, the signature verification control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 046:** For Pipeline RBAC, the S3 endpoint control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 047:** For Pipeline RBAC, the bucket policy control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 048:** For Pipeline RBAC, the object prefix design control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 049:** For Pipeline RBAC, the artifact lineage control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 050:** For Pipeline RBAC, the artifact retention control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 051:** For Pipeline RBAC, the metadata database control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 052:** For Pipeline RBAC, the database backup control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 053:** For Pipeline RBAC, the database connection pool control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 054:** For Pipeline RBAC, the workspace PVC control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 055:** For Pipeline RBAC, the storage class control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 056:** For Pipeline RBAC, the access mode control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 057:** For Pipeline RBAC, the capacity planning control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 058:** For Pipeline RBAC, the latency budget control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 059:** For Pipeline RBAC, the throughput control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 060:** For Pipeline RBAC, the small-object performance control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 061:** For Pipeline RBAC, the caching control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 062:** For Pipeline RBAC, the cache invalidation control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 063:** For Pipeline RBAC, the parameter design control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 064:** For Pipeline RBAC, the default values control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 065:** For Pipeline RBAC, the schema evolution control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 066:** For Pipeline RBAC, the version compatibility control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 067:** For Pipeline RBAC, the logging control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 068:** For Pipeline RBAC, the metrics control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 069:** For Pipeline RBAC, the events control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 070:** For Pipeline RBAC, the audit trail control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 071:** For Pipeline RBAC, the correlation ID control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 072:** For Pipeline RBAC, the alerting control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 073:** For Pipeline RBAC, the SLO control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 074:** For Pipeline RBAC, the error budget control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 075:** For Pipeline RBAC, the runbook control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 076:** For Pipeline RBAC, the incident ownership control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 077:** For Pipeline RBAC, the change control control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 078:** For Pipeline RBAC, the release promotion control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 079:** For Pipeline RBAC, the rollback control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 080:** For Pipeline RBAC, the disaster recovery control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 081:** For Pipeline RBAC, the multi-tenancy control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 082:** For Pipeline RBAC, the quota control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 083:** For Pipeline RBAC, the cost allocation control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 084:** For Pipeline RBAC, the cleanup control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 085:** For Pipeline RBAC, the legal hold control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 086:** For Pipeline RBAC, the testing control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 087:** For Pipeline RBAC, the unit test control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 088:** For Pipeline RBAC, the integration test control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 089:** For Pipeline RBAC, the failure injection control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 090:** For Pipeline RBAC, the load test control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 091:** For Pipeline RBAC, the GitOps control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 092:** For Pipeline RBAC, the CI validation control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 093:** For Pipeline RBAC, the policy as code control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 094:** For Pipeline RBAC, the documentation control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 095:** For Pipeline RBAC, the support model control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 096:** For Pipeline RBAC, the architecture boundary control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 097:** For Pipeline RBAC, the business objective control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 098:** For Pipeline RBAC, the data contract control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 099:** For Pipeline RBAC, the input validation control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 100:** For Pipeline RBAC, the output validation control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 101:** For Pipeline RBAC, the idempotency control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 102:** For Pipeline RBAC, the retry safety control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 103:** For Pipeline RBAC, the timeout strategy control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 104:** For Pipeline RBAC, the resource requests control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 105:** For Pipeline RBAC, the resource limits control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 106:** For Pipeline RBAC, the CPU sizing control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 107:** For Pipeline RBAC, the memory sizing control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 108:** For Pipeline RBAC, the GPU scheduling control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 109:** For Pipeline RBAC, the node placement control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 110:** For Pipeline RBAC, the taints and tolerations control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 111:** For Pipeline RBAC, the topology control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 112:** For Pipeline RBAC, the service account control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 113:** For Pipeline RBAC, the RBAC control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 114:** For Pipeline RBAC, the secret handling control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 115:** For Pipeline RBAC, the token lifetime control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 116:** For Pipeline RBAC, the network policy control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 117:** For Pipeline RBAC, the egress control control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 118:** For Pipeline RBAC, the DNS dependency control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 119:** For Pipeline RBAC, the proxy behavior control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 120:** For Pipeline RBAC, the TLS trust control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 121:** For Pipeline RBAC, the certificate rotation control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 122:** For Pipeline RBAC, the image provenance control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 123:** For Pipeline RBAC, the image digest pinning control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 124:** For Pipeline RBAC, the SBOM control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 125:** For Pipeline RBAC, the vulnerability scanning control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 126:** For Pipeline RBAC, the signature verification control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 127:** For Pipeline RBAC, the S3 endpoint control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 128:** For Pipeline RBAC, the bucket policy control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 129:** For Pipeline RBAC, the object prefix design control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 130:** For Pipeline RBAC, the artifact lineage control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 131:** For Pipeline RBAC, the artifact retention control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 132:** For Pipeline RBAC, the metadata database control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 133:** For Pipeline RBAC, the database backup control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 134:** For Pipeline RBAC, the database connection pool control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 135:** For Pipeline RBAC, the workspace PVC control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 136:** For Pipeline RBAC, the storage class control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 137:** For Pipeline RBAC, the access mode control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 138:** For Pipeline RBAC, the capacity planning control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 139:** For Pipeline RBAC, the latency budget control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 140:** For Pipeline RBAC, the throughput control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 141:** For Pipeline RBAC, the small-object performance control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 142:** For Pipeline RBAC, the caching control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 143:** For Pipeline RBAC, the cache invalidation control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 144:** For Pipeline RBAC, the parameter design control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 145:** For Pipeline RBAC, the default values control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 146:** For Pipeline RBAC, the schema evolution control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 147:** For Pipeline RBAC, the version compatibility control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 148:** For Pipeline RBAC, the logging control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 149:** For Pipeline RBAC, the metrics control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 150:** For Pipeline RBAC, the events control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 151:** For Pipeline RBAC, the audit trail control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 152:** For Pipeline RBAC, the correlation ID control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 153:** For Pipeline RBAC, the alerting control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 154:** For Pipeline RBAC, the SLO control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 155:** For Pipeline RBAC, the error budget control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 156:** For Pipeline RBAC, the runbook control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 157:** For Pipeline RBAC, the incident ownership control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 158:** For Pipeline RBAC, the change control control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 159:** For Pipeline RBAC, the release promotion control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 160:** For Pipeline RBAC, the rollback control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 161:** For Pipeline RBAC, the disaster recovery control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 162:** For Pipeline RBAC, the multi-tenancy control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 163:** For Pipeline RBAC, the quota control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 164:** For Pipeline RBAC, the cost allocation control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 165:** For Pipeline RBAC, the cleanup control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 166:** For Pipeline RBAC, the legal hold control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 167:** For Pipeline RBAC, the testing control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 168:** For Pipeline RBAC, the unit test control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 169:** For Pipeline RBAC, the integration test control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 170:** For Pipeline RBAC, the failure injection control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 171:** For Pipeline RBAC, the load test control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 172:** For Pipeline RBAC, the GitOps control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 173:** For Pipeline RBAC, the CI validation control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 174:** For Pipeline RBAC, the policy as code control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 175:** For Pipeline RBAC, the documentation control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 176:** For Pipeline RBAC, the support model control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 177:** For Pipeline RBAC, the architecture boundary control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 178:** For Pipeline RBAC, the business objective control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 179:** For Pipeline RBAC, the data contract control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 180:** For Pipeline RBAC, the input validation control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 181:** For Pipeline RBAC, the output validation control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 182:** For Pipeline RBAC, the idempotency control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 183:** For Pipeline RBAC, the retry safety control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 184:** For Pipeline RBAC, the timeout strategy control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 185:** For Pipeline RBAC, the resource requests control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 186:** For Pipeline RBAC, the resource limits control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 187:** For Pipeline RBAC, the CPU sizing control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 188:** For Pipeline RBAC, the memory sizing control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 189:** For Pipeline RBAC, the GPU scheduling control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 190:** For Pipeline RBAC, the node placement control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 191:** For Pipeline RBAC, the taints and tolerations control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 192:** For Pipeline RBAC, the topology control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 193:** For Pipeline RBAC, the service account control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 194:** For Pipeline RBAC, the RBAC control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
- **Standard 195:** For Pipeline RBAC, the secret handling control must explicitly reduce the risk of wildcard RBAC; evidence must be reviewable by another engineer.
- **Standard 196:** For Pipeline RBAC, the token lifetime control must explicitly reduce the risk of cross-project access; evidence must be reviewable by another engineer.
- **Standard 197:** For Pipeline RBAC, the network policy control must explicitly reduce the risk of unsigned images; evidence must be reviewable by another engineer.
- **Standard 198:** For Pipeline RBAC, the egress control control must explicitly reduce the risk of token overreach; evidence must be reviewable by another engineer.
- **Standard 199:** For Pipeline RBAC, the DNS dependency control must explicitly reduce the risk of default service account misuse; evidence must be reviewable by another engineer.
- **Standard 200:** For Pipeline RBAC, the proxy behavior control must explicitly reduce the risk of secret exposure; evidence must be reviewable by another engineer.
...
### 20.1. Production verification record — rollback
- **Topic:** Pipeline RBAC
...
### 20.2. Production verification record — disaster recovery
- **Topic:** Pipeline RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.3. Production verification record — multi-tenancy
- **Topic:** Pipeline RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.4. Production verification record — quota
- **Topic:** Pipeline RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.5. Production verification record — cost allocation
- **Topic:** Pipeline RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.6. Production verification record — cleanup
- **Topic:** Pipeline RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.7. Production verification record — legal hold
- **Topic:** Pipeline RBAC
- **Risk addressed:** cross-project access
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.8. Production verification record — testing
- **Topic:** Pipeline RBAC
- **Risk addressed:** unsigned images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.9. Production verification record — unit test
- **Topic:** Pipeline RBAC
- **Risk addressed:** token overreach
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.10. Production verification record — integration test
- **Topic:** Pipeline RBAC
- **Risk addressed:** default service account misuse
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.11. Production verification record — failure injection
- **Topic:** Pipeline RBAC
- **Risk addressed:** secret exposure
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.12. Production verification record — load test
- **Topic:** Pipeline RBAC
- **Risk addressed:** wildcard RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.13. Production verification record — GitOps
- **Topic:** Pipeline RBAC
- **Risk addressed:** cross-project access
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.14. Production verification record — CI validation
- **Topic:** Pipeline RBAC
- **Risk addressed:** unsigned images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.15. Production verification record — policy as code
- **Topic:** Pipeline RBAC
- **Risk addressed:** token overreach
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.16. Production verification record — documentation
- **Topic:** Pipeline RBAC
- **Risk addressed:** default service account misuse
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.17. Production verification record — support model
- **Topic:** Pipeline RBAC
- **Risk addressed:** secret exposure
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.18. Production verification record — architecture boundary
- **Topic:** Pipeline RBAC
- **Risk addressed:** wildcard RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.19. Production verification record — business objective
- **Topic:** Pipeline RBAC
- **Risk addressed:** cross-project access
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.20. Production verification record — data contract
- **Topic:** Pipeline RBAC
- **Risk addressed:** unsigned images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.21. Production verification record — input validation
- **Topic:** Pipeline RBAC
- **Risk addressed:** token overreach
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.22. Production verification record — output validation
- **Topic:** Pipeline RBAC
- **Risk addressed:** default service account misuse
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.23. Production verification record — idempotency
- **Topic:** Pipeline RBAC
- **Risk addressed:** secret exposure
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.24. Production verification record — retry safety
- **Topic:** Pipeline RBAC
- **Risk addressed:** wildcard RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.25. Production verification record — timeout strategy
- **Topic:** Pipeline RBAC
- **Risk addressed:** cross-project access
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.26. Production verification record — resource requests
- **Topic:** Pipeline RBAC
- **Risk addressed:** unsigned images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.27. Production verification record — resource limits
- **Topic:** Pipeline RBAC
- **Risk addressed:** token overreach
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.28. Production verification record — CPU sizing
- **Topic:** Pipeline RBAC
- **Risk addressed:** default service account misuse
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.29. Production verification record — memory sizing
- **Topic:** Pipeline RBAC
- **Risk addressed:** secret exposure
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.30. Production verification record — GPU scheduling
- **Topic:** Pipeline RBAC
- **Risk addressed:** wildcard RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.31. Production verification record — node placement
- **Topic:** Pipeline RBAC
- **Risk addressed:** cross-project access
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.32. Production verification record — taints and tolerations
- **Topic:** Pipeline RBAC
- **Risk addressed:** unsigned images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.33. Production verification record — topology
- **Topic:** Pipeline RBAC
- **Risk addressed:** token overreach
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.34. Production verification record — service account
- **Topic:** Pipeline RBAC
- **Risk addressed:** default service account misuse
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.35. Production verification record — RBAC
- **Topic:** Pipeline RBAC
- **Risk addressed:** secret exposure
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.36. Production verification record — secret handling
- **Topic:** Pipeline RBAC
- **Risk addressed:** wildcard RBAC
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.37. Production verification record — token lifetime
- **Topic:** Pipeline RBAC
- **Risk addressed:** cross-project access
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.38. Production verification record — network policy
- **Topic:** Pipeline RBAC
- **Risk addressed:** unsigned images
...
- **Audit record:** Save timestamp, operator, commit, image digest, pipeline version, run identifier, and ticket.
- **Review:** A second engineer confirms the evidence and closes any gap.
### 20.39. Production verification record — egress control
- **Topic:** Pipeline RBAC
- **Risk addressed:** token overreach
